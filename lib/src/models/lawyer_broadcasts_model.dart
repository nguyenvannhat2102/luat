...
GetLawyerBroadcastsModel getLawyerBroadcastsModelFromJson(String str) =>
    GetLawyerBroadcastsModel.fromJson(json.decode(str));
String getLawyerBroadcastsModelToJson(GetLawyerBroadcastsModel data) =>
    json.encode(data.toJson());

class GetLawyerBroadcastsModel {
  GetLawyerBroadcastsModel({
    GetLawyerBroadcastsDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  }) {
  ...
  GetLawyerBroadcastsModel.fromJson(dynamic json) {
    _data = json['data'] != null
        ? GetLawyerBroadcastsDataModel.fromJson(json['data'])
        : null;
    _success = json['success'];
    _message = json['message'];
    _errors = json['errors'];
  }
  GetLawyerBroadcastsDataModel? _data;
  bool? _success;
  String? _message;
  dynamic _errors;
  GetLawyerBroadcastsModel copyWith({
    GetLawyerBroadcastsDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  ...
  GetLawyerBroadcastsDataModel? get data => _data;
...
GetLawyerBroadcastsDataModel getLawyerBroadcastsDataModelFromJson(String str) =>
    GetLawyerBroadcastsDataModel.fromJson(json.decode(str));
String getLawyerBroadcastsDataModelToJson(GetLawyerBroadcastsDataModel data) =>
    json.encode(data.toJson());

class GetLawyerBroadcastsDataModel {
  ...
  GetLawyerBroadcastsDataModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(BroadcastModel.fromJson(v));
      });
    }
    _links = json['links'] != null ? Links.fromJson(json['links']) : null;
    _meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
  }
  List<BroadcastModel>? _data;
  Links? _links;
  Meta? _meta;
  GetLawyerBroadcastsDataModel copyWith({
    List<BroadcastModel>? data,
    Links? links,
    Meta? meta,
  }) =>
  ...
  List<BroadcastModel>? get data => _data;
...
class BroadcastModel {
  ...
  BroadcastModel.fromJson(dynamic json) {
    _id = json['id'];
