...
EditUserProfileModel editGeneralInfoFromJson(String str) =>
    EditUserProfileModel.fromJson(json.decode(str));
String editGeneralInfoToJson(EditUserProfileModel data) =>
